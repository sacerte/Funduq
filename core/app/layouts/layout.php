  ...
  <body class="<?php if(isset($_SESSION["user_id"])):?>  skin-blue-light sidebar-mini <?php else:?>login-page<?php endif; ?>" >
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="./" class="logo">
          ...
          <span class="logo-lg">FM<b>FUNDUQ</b></span>
        </a>
    ...
    <?php endif;?>
      ...
      <div class="content-wrapper">
        ...
        <strong>Copyright &copy; 2017 <a href="https://www.linkedin.com/in/yasermeshir/" target="_blank">Sacerte</a></strong>
      </footer>
      <?php else:?>

<div class="login-box">
      <div class="login-logo">
        <a href="./">FM<b>FUNDUQ</a>
      </div><!-- /.login-logo -->
